function GUI_MerchantMenu()
	...
	client:EmitSound(table.Random(GAMEMODE.MerchantSounds.MerchantWelcome))
	GUI_Background:SetSize(SW,SH)
	GUI_Background:SetPos(0,0)
	GUI_Background:SetDraggable(false)
	...
	GUI_Property_Sheet:SetSize(SW - 10,SH - 50 )
