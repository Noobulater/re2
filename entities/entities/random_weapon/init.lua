...
function ENT:Initialize()
	...
	elseif (itemnumber >= 3 && itemnumber <= 6) then
		entity:SetNWString("Class", "item_aug")
	elseif (itemnumber >= 6 && itemnumber <= 9) then
		entity:SetNWString("Class", "item_pumpshot")
	elseif (itemnumber >= 9 && itemnumber <= 12) then	
		entity:SetNWString("Class", "item_ump")
	else 
